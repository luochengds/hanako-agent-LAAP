...
export const BUILTIN_EVENT_BUS_CAPABILITIES = Object.freeze([
  ...
  {
    type: "provider:register-runtime-media-capability-source",
    title: "Register runtime media capabilities",
    description: "Register a process-local provider capability discovery source owned by the calling plugin.",
    inputSchema: OBJECT_SCHEMA,
    outputSchema: OBJECT_SCHEMA,
  ...
  {
    type: "provider:unregister-runtime-media-capability-source",
    title: "Unregister runtime media capabilities",
    description: "Remove a process-local provider capability discovery source owned by the calling plugin.",
    inputSchema: OBJECT_SCHEMA,
    outputSchema: OBJECT_SCHEMA,
    permission: "providers.manage",
    errors: ["NO_HANDLER", "TIMEOUT", "FORBIDDEN", "INTERNAL_ERROR"],
