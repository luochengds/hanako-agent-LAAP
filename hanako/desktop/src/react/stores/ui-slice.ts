...
export interface UiSlice {
  ...
  /** P3-1v1-protocol: 当前 1v1 对话的对端 LAAPer（null = 未开启） */
  laaperChatPeer: { public_key: string; name: string; color: string } | null;
  /** P3-trio-chatroom: 当前三人聊天室的成员列表（null = 未开启） */
  trioChatMembers: { public_key: string; name: string; color: string }[] | null;
  ...
  setLaaperChatPeer: (peer: { public_key: string; name: string; color: string } | null) => void;
  setTrioChatMembers: (members: { public_key: string; name: string; color: string }[] | null) => void;
...
export const createUiSlice = (
  ...
  setLaaperChatPeer: (peer) => set({ laaperChatPeer: peer }),
  setTrioChatMembers: (members) => set({ trioChatMembers: members }),
