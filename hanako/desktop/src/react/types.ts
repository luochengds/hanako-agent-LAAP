...
// ── 浮动面板类型 ──
export type ActivePanel = 'activity' | 'automation' | 'bridge' | 'skills' | 'bubble-field' | 'birth-ceremony' | 'skill-packs' | 'hot-compile-preview' | 'laaper-chat' | 'trio-chatroom' | 'charter-guardian' | 'laaper-market' | null;
